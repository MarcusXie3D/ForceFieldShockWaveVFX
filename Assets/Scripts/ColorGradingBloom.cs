...
//[ExecuteInEditMode]
public class ColorGradingBloom : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        dualFilterBloomMat = new Material(Shader.Find("Custom/DualFilterBloom"));
    ...
    // if the platform doesn't suppot these effects, this script will be disabled
    void NotSupported()
    {
        enabled = false;
        isSupported = false;
